-- Migration 013: nuevos umbrales de alertas
-- pendiente:  2 días en estado     (antes 3)
-- comprado:   8 días en estado     (antes 7)
-- NUEVO: si han pasado 15 días desde creación sin llegar a bodega_colombia
...
create or replace view vista_pedidos_asesor as
  select
    ...
    case
      ...
      when p.estado in ('pendiente','comprado','llego_usa')
