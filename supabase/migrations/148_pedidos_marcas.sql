-- Filtro por marca de la galería/lista: antes se armaba una lista de ids de
-- pedidos coincidentes con tope de 300 (límite de largo de URL) y los pedidos
-- que quedaban por fuera desaparecían del filtro (ej: TR7095/TR7097 con 478+
-- items Adidas). La vista ahora expone `marcas` (array en minúsculas, marca
-- del item o del catálogo enlazado) y el filtro va directo en la consulta.
...
-- Regla de la migración 111: anon no debe tener acceso a objetos de negocio.
